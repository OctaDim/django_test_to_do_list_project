...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=1440),  # TEMPORALLY ONLY WHEN DEV
    ...
    "ALGORITHM": "HS256",
    "SIGNING_KEY": SECRET_KEY,  # CHANGED, NOT DEFAULT, FROM DJANGO SETTINGS
    "VERIFYING_KEY": "",
    "AUDIENCE": None,
    "ISSUER": None,
    "JSON_ENCODER": None,
    ...
    "AUTH_HEADER_TYPES": ("JWT",),  # CHANGED, NOT DEFAULT, from Bearer => JWT
    ...
    "TOKEN_OBTAIN_SERIALIZER": "apps.jwt_config.serializers.CustomTokenObtainPairSerializer",  # Custom JWT serializer
    # "TOKEN_OBTAIN_SERIALIZER": "rest_framework_simplejwt.serializers.TokenObtainPairSerializer",  # Default JWT serializer
